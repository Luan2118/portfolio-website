...
const projects = [
  {
    ...
    highlights: [
      ...
      "Active workout flow with exercises, sets, previous results, and a workout timer.",
      "Dashboard for recent workouts, weekly volume, body weight changes, and quick actions.",
      "Exercise progress with charts, history, filters, and performance data.",
    ],

    stack: ["React", "TypeScript", "Supabase", "Chart.js"],
    githubUrl: "https://github.com/Luan2118/gym-tracker",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Demo account for quick testing: demo@example.com / Demo1234",
    ],
    stack: ["JavaScript", "Node.js", "Express", "MongoDB", "Chart.js"],
    githubUrl: "https://github.com/Luan2118/finance-tracker",
