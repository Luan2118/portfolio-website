      ...
      <Container>
        <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-8 shadow-sm md:p-10">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <a href="mailto:leluanvn21@seznam.cz"  className="inline-flex justify-center items-center bg-neutral-950 text-white text-sm rounded-lg py-2 px-4 font-semibold transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-950 focus-visible:rounded-lg  hover:bg-neutral-800">Email me</a>
